...
import {
    CheckCircle, Truck, Package, Shield, Printer, Download,
    Home, ShoppingBag, MapPin, Clock, Mail, Phone,
    CreditCard, Share2, AlertCircle
} from "lucide-react";
...
export default function ConfirmationContent() {
    ...
    const getEstimatedDelivery = () => {
        ...
        const deliveryDays =
            order?.deliveryOption === "express" ? 2 :
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-center">
                        <div className="flex items-center w-full max-w-2xl">
                            ...
                            <div className="flex flex-col items-center">
                                <div className="w-8 h-8 rounded-full bg-[#1b2358] text-white flex items-center justify-center">3</div>
            ...
            <div className="container mx-auto px-4 py-8 print:py-2">
                ...
                <div className="text-center mb-10 print:mb-6">
                    ...
                    <div className="flex items-center justify-center gap-4">
                        <Badge className="bg-green-100 text-green-800 hover:bg-green-100">Order #{order.orderId}</Badge>
                        <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-100">Paid</Badge>
                        <Badge className="bg-[#FBB320] text-[#1b2358] hover:bg-[#FBB320]">{items.length} items</Badge>
                    </div>
                </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-gray-400">
                                                Will be shipped via {order.deliveryOption === "express" ? "Express" : "Standard"} Delivery
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center justify-between mb-1">
                                                    ...
                                                    <div className="font-mono font-bold text-yellow-700">{formatTime(timeLeft)}</div>
                                                </div>
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-start justify-between">
                                                    ...
                                                    <div className="text-right">
                                                        <div className="font-bold text-[#1b2358]">LSL {item.total.toFixed(2)}</div>
                                                        <div className="text-sm text-gray-500">LSL {item.unitPrice.toFixed(2)} × {item.quantity}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <Card className="sticky top-24">
                            <CardContent className="p-6">
                                ...
                                <div className="space-y-3 mb-8">
                                    ...
                                    <Button onClick={handleShareOrder} variant="outline" className="w-full">
                                    ...
                                    <div className="p-4 bg-blue-50 rounded-lg">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-blue-700">We'll send SMS updates to {customer.phone}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="p-4 bg-green-50 rounded-lg">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-green-700">30-day return policy & damage protection included</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="mt-8 pt-8 border-t">
                                    <div className="text-center">
                                        ...
                                        <p className="text-3xl font-bold text-[#1b2358]">LSL {orderSummary.total.toFixed(2)}</p>
                                        <p className="text-sm text-gray-500 mt-1">Includes LSL {orderSummary.tax.toFixed(2)} VAT</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
