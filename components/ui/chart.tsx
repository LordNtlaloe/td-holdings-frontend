    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.map((item: ChartTooltipPayloadItem, index: number) => {
          ...
          const itemConfig = getPayloadConfigFromPayload(config, item, key)
          const indicatorColor = color || item.payload?.fill || item.color || item.fill || item.stroke
...
// Export additional Recharts components for convenience
export {
  ChartContainer,
  ChartTooltip,
  ChartTooltipContent,
...
// Re-export commonly used Recharts primitives
export const Recharts = {
  ...
  Surface: RechartsPrimitive.Surface,
  ...
  Symbols: RechartsPrimitive.Symbols,
