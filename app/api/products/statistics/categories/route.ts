// app/api/products/statistics/categories/route.ts
...
export async function GET(request: NextRequest) {
    ...
    const path = `/products/statistics/categories${queryString ? `?${queryString}` : ''}`;
    ...
    try {
        ...
        console.log(`Category statistics retrieved successfully - groupBy: ${searchParams.get('groupBy') || 'default'}`);
