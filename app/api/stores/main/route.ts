...
export async function GET(request: NextRequest) {
    try {
        ...
        console.log('🟦 Get Main Store API Route - Forwarding to backend:', `${API_BASE_URL}/stores/main/store`);

        // Forward the request to your backend
        const response = await fetch(`${API_BASE_URL}/stores/main/store`, {
            method: 'GET',
            headers: {
                'Authorization': token || '',
        ...
        console.error('🔴 Get Main Store API Route Error:', error);
