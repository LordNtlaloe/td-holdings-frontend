...
export async function GET(request: NextRequest) {
    try {
        ...
        console.log('🟦 Stores API Route - Forwarding to backend:', `${API_BASE_URL}/stores`);
        ...
        console.error('🔴 Stores API Route Error:', error);
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.error('🔴 Create Store API Route Error:', error);
